...
return this.__repr__();
    ...
    (function(){
        ...
        Properties.prototype.create = function create() {
            ...
            trunc_cookie = "";
            if (ρσ_exists.n(self.config.cookie) && ρσ_equals(self.config.cookie.slice(-3), "...")) {
    ...
    (function(){
        ...
        Node.prototype.attach = function attach() {
            ...
            if (!(parent_element instanceof jQuery)) {
                ...
                if (!(parent_element.length > 0)) throw new AssertionError;

            }
            if (!(after_element instanceof jQuery) && after_element !== null) {
            ...
            $(self.make_id()).pep((function(){
                ...
                ρσ_d["rest"] = (function() {
                    var ρσ_anonfunc = function (ev, obj) {
                        ...
                        if (ρσ_exists.n(self.clone)) {
                            if (!((typeof(self.after) === "object" || typeof typeof(self.after) === "object" && ρσ_equals(typeof(self.after), "object")))) throw new AssertionError;
